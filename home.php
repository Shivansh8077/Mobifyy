...
<nav class="nav nav-default navbar-fixed-top">
    <div class="container" style="background-color: rgba(249,249,249,0.6)">
        <div class="navbar-header" >
            ...
            <?php
            if(isset($_SESSION['email'])){?>
                <a href="home.php" class="navbar-brand black_color">Mobifyy</a>
            <?php
            }else {
                ?>
                <a href="index.php" class="navbar-brand black_color">Mobifyy</a>
                <?php
            }
            ?>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    if(check_if_added(10))
                    {
                       ...
                       echo '<a href="cart_add.php?id=10"><button type="button" class="btn btn-primary btn-block">Add to cart</button></a>';
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    if(check_if_added(11))
                    {
                      ...
                      echo '<a href="cart_add.php?id=11"><button type="button" class="btn btn-primary btn-block">Add to cart</button> </a>';
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    if(check_if_added(12))
                    {
                        ...
                        echo '<a href="cart_add.php?id=12"><button type="button" class="btn btn-primary btn-block">Add to cart</button></a>';
                    }
                    ?>
                </div>
            </div>
